...
# %%
inputs = pd.read_csv("../Data/df_inputs_newPCA_PhysPrior_wave1.csv").values
...
df_metrics.to_csv('../Data/df_metrics_newPCA_PhysPrior_wave1.csv', index=False)
...
df_obs_nonoise.to_csv('../Data/df_obs_nonoise_newPCA_PhysPrior_wave1.csv', index=False)

# %% [markdown]
# ## 2) wave 2

# %%
inputs2 = pd.read_csv("../Data/exp_TuningL94_newPCA_PhysPrior_wave2.csv").values
...
results2 = Parallel(n_jobs=20)(delayed(metric)(i) for i in inputs2)
...
df_metrics.to_csv('../Data/df_metrics_newPCA_PhysPrior_wave2.csv', index=False)

# %% [markdown]
# # wave3

# %%
inputs3 = pd.read_csv("../Data/exp_TuningL94_newPCA_PhysPrior_wave3.csv").values
...
df_metrics.to_csv('../Data/df_metrics_newPCA_PhysPrior_wave3.csv', index=False)
...
# %%
inputs4 = pd.read_csv("../Data/exp_TuningL94_newPCA_PhysPrior_wave4.csv").values
...
df_metrics.to_csv('../Data/df_metrics_newPCA_PhysPrior_wave4.csv', index=False)
...
# %%
inputs5 = pd.read_csv("../Data/exp_TuningL94_newPCA_PhysPrior_wave5.csv").values
...
df_metrics.to_csv('../Data/df_metrics_newPCA_PhysPrior_wave5.csv', index=False)
...
# %%
configs = pd.read_csv("../Data/finaltestpoints_newPCA_PhysPrior.csv").values
configs.tolist()
